...
from algorithms.fedntd_analysis.ClientTrainer import ClientTrainer
from algorithms.fedntd_analysis.criterion import *
...
class Server:
    ...
    def run(self, save_rounds=[], name="test"):
        ...
        for round_idx in range(self.n_rounds):
            ...
            self.server_results["round_history"].append(round_results)
            ...
            if self.evaluator is not None:
                ...
                self.server_results["eval_history"].append(eval_results)
            ...
            if (round_idx + 1) in save_rounds:
                torch.save(
                    self.model.state_dict(), "./{}_{}.pth".format(name, round_idx)
                )
    ...
    def _get_local_criterion(self, algo_params, num_classes):
        ...
        if algo_params.loss_type == "lsd":
            criterion = LSD_Loss(num_classes, tau, beta)
