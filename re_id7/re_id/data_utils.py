...
class Data():
    def __init__(self, datasets, data_dir, batch_size, erasing_p, color_jitter, train_all):
        ...
        self.train_all = '_all' if train_all else '' #''로  처리 됨!!
    ...
    def preprocess_one_train_dataset(self, dataset): # 한 클라이언트의 train dataset, train loader를 output으로 내놓는다.
        ...
        return loader, image_dataset #trainloader, 계층화된  dataset을 return!!
...
#             print(b is d)
    ...
    def preprocess(self): # self.train_loaders = {}, self.train_dataset_sizes = {}, self.train_class_sizes = {}, self.test_loaders = {}, self.gallery_meta = {}, self.query_meta = {}을 만드는 게 목표!
