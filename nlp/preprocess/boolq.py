...
ag_train = load_dataset('super_glue','boolq', split='train', cache_dir='./download') # data 폴더 안에 따로 만드는 게 좋을 듯
ag_test = load_dataset('super_glue','boolq', split='validation', cache_dir='./download')
...
train1=train[:3142]
train2=train[3142:6284]
train3=train[6284:9426]
