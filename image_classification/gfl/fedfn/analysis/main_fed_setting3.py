...
if __name__ == '__main__':
    ...
    if args.iid:
        base_dir = './save/full_and_body/test/{}_iid{}_num{}_C{}_le{}_m{}_wd{}_round_{}/'.format(
            args.model, args.iid, args.num_users, args.frac, args.local_ep, args.momentum, args.wd, args.epochs)
        
    else:
        if args.hetero_option=="shard":

            base_dir = './save/full_and_body/{}_iid{}_num{}_C{}_le{}_m{}_wd{}_round_{}/shard2_new/decay_{}/'.format(
