...
if __name__ == '__main__':
    ...
    assert args.local_upt_part in ['full'] and args.aggr_part in ['body']
    ...
    for iter in range(args.epochs):
        ...
        for idx in idxs_users:
            ...
            #updated head part is reflected
            net_local_list[idx].load_state_dict(w_local, strict=False)
        ...
        update_keys = [k for k in update_keys if 'classifier' not in k]
