...
class Server:
    ...
    def train(self):
        ...
        for fed_round in range(self.n_rounds):
            ...
            wandb.log(
                {
                    "norm_g2l_mean": norm_g2l_mean,
                    "norm_g2l_std": norm_g2l_std,
                    "norm_l2l_mean": norm_l2l_mean,
                    "norm_l2l_std": norm_l2l_std,
                },
                step=fed_round,
            )
            ####################################################################
            ...
            # Send log to wandb
            wandb_logger(total_results, round_results, fed_round, angles=None)
