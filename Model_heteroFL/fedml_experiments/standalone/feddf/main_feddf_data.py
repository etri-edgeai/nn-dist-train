...
def get_proj_name(pname):
    if pname == "con":
        ...
        "-localepoch_" + str(args.epochs) + "-conrand_" + str(args.con_rand) + "-ol" + str(args.outer_loops) + \
   ...
   "-unlabel" + str(args.unlabeled_dataset) + "-fedmix_" + str(args.fedmix)
        ...
        display_name = "Fedavg" + \
         "-epoch" + str(args.epochs)  +"-alpha" + str(args.partition_alpha) + \
        "-ssteps_" +  str(args.server_steps) + \
     "-unlabeldata_" + str(args.unlabeled_dataset) + \
   "-unlabel" + str(args.unlabeled_dataset) + "-fedmix_" + str(args.fedmix)
        project_name = "fedcon"
